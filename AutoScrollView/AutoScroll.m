...
-(void)createPageController{
    ...
    _pageController.center = CGPointMake(self.frame.size.width-50, self.frame.size.height+5);
...
-(void)handleGesture:(UITapGestureRecognizer *)tap{
    ...
    //NSLog(@"%@",self.roomIdArr[tap.view.tag]);
}
-(void)createTitle{
    _leftLabel = [[UILabel alloc]init];
    _leftLabel.tag = _titleArray.count-1;
    ...
    _leftLabel.text = _titleArray[_leftLabel.tag];
    _centerLabel.text = _titleArray[_centerLabel.tag];
    _rightLabel.text = _titleArray[_rightLabel.tag];
...
-(void)updateContent{
    ...
    _leftLabel.text = [_titleArray objectAtIndex:_leftImageView.tag];
    _centerLabel.text = [_titleArray objectAtIndex:_centerImageView.tag];
    _rightLabel.text = [_titleArray objectAtIndex:_rightImageView.tag];
